# -*- coding: utf-8 -*-
# File: cascade_rcnn_r50_fpn.py

# 1. Import settings: model code + pipelines
custom_imports = dict(
    imports=[
        'mmdet.models',
        'mmdet.datasets',
        ...
        'mmdet.datasets.pipelines.formatting.formatting',
        'mmdet.datasets.pipelines.formatting.default_format_bundle',
        'mmdet.datasets.pipelines.formatting.packaging',
    ],
...
test_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='test.json',  # Update this to your actual test annotation file if needed
        data_prefix=dict(img='test/'),  # Update this to your actual test image directory if needed
        test_mode=True,
        pipeline=test_pipeline,
        metainfo=dict(
            classes=(
...
test_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'test.json',  # Update this to your actual test annotation file if needed
    metric=['bbox'],
    classwise=True,
    proposal_nums=(100, 1000, 3000),
    iou_thrs=[0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95]
